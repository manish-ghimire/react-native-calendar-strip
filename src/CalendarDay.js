...
class CalendarDay extends Component {
  ...
  renderMarking() {
    ...
    if (
      marking.ticks &&
      Array.isArray(marking.ticks) &&
      marking.ticks.length > 0
    ) {
      return this.renderTicks(marking);
    }
  ...
  renderTicks(marking) {
    return (
      <View style={{ width: 20, height: 20 }}>
        <Text
          style={{
            color: marking.ticks[0].selectedColor,
            fontSize: 18,
            textAlign: "center",
          }}
        >
    ...
    validDots = marking.dots
      ...
      .map((dot, index) => {
        ...
        return (
          ...
          >
            {/* <View style={[baseDotStyle, { backgroundColor }, markedDatesStyle]} /> */}
            <Text
              style={{ color: marking.dots[0].selectedColor, fontSize: 12 }}
            >
              &#9679;
            </Text>
          </View>
    ...
    validLines = marking.lines
      ...
      .map((line, index) => {
        ...
        return (
          ...
          >
            {/* <View style={[baseLineStyle, { backgroundColor, width }, markedDatesStyle]} /> */}
            <Text
              style={{
                color: marking.lines[0].selectedColor,
                fontSize: 18,
                textAlign: "center",
              }}
            >
